...
| [AgentPay](https://github.com/romudille-bit/agentpay) | x402 payment gateway for AI agents. Pay-per-call crypto data tools (price, whale activity, gas, TVL, Fear & Greed, Dune queries) on Stellar and Base — no API keys or subscriptions. MCP-native. |
